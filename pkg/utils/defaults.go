...
func GenerateSchemaDefaultsFromDescribeConfig(params []Param) map[string]string {
...
// Param represents a PostgreSQL configuration parameter (defined here to avoid import cycle)
type Param struct {
	Name      string
	VarType   string
	Unit      string
