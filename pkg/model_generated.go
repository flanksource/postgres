...
type PostgresConf struct {
	...
	// each.
	EffectiveCacheSize int `json:"effective_cache_size,omitempty" yaml:"effective_cache_size,omitempty" mapstructure:"effective_cache_size,omitempty"`
	...
	GinPendingListLimit int `json:"gin_pending_list_limit,omitempty" yaml:"gin_pending_list_limit,omitempty" mapstructure:"gin_pending_list_limit,omitempty"`
	...
	IoCombineLimit int `json:"io_combine_limit,omitempty" yaml:"io_combine_limit,omitempty" mapstructure:"io_combine_limit,omitempty"`
	...
	// limit.
	TempFileLimit int `json:"temp_file_limit,omitempty" yaml:"temp_file_limit,omitempty" mapstructure:"temp_file_limit,omitempty"`
	...
	WalBuffers int `json:"wal_buffers,omitempty" yaml:"wal_buffers,omitempty" mapstructure:"wal_buffers,omitempty"`
	...
	WalSkipThreshold int `json:"wal_skip_threshold,omitempty" yaml:"wal_skip_threshold,omitempty" mapstructure:"wal_skip_threshold,omitempty"`
...
func (j *PostgresConf) UnmarshalJSON(value []byte) error {
	...
	if v, ok := raw["bgwriter_lru_multiplier"]; !ok || v == nil {
		plain.BgwriterLruMultiplier = 0.0
	}
	if 10 < plain.BgwriterLruMultiplier {
	...
	if v, ok := raw["effective_cache_size"]; !ok || v == nil {
		plain.EffectiveCacheSize = 0.0
	}
	if 2147483647 < plain.EffectiveCacheSize {
		return fmt.Errorf("field %s: must be <= %v", "effective_cache_size", 2147483647)
	}
	if 1 > plain.EffectiveCacheSize {
	...
	if v, ok := raw["gin_pending_list_limit"]; !ok || v == nil {
		plain.GinPendingListLimit = 0.0
	}
	if 2147483647 < plain.GinPendingListLimit {
		return fmt.Errorf("field %s: must be <= %v", "gin_pending_list_limit", 2147483647)
	}
	if 64 > plain.GinPendingListLimit {
	...
	if v, ok := raw["io_combine_limit"]; !ok || v == nil {
		plain.IoCombineLimit = 0.0
	}
	if 32 < plain.IoCombineLimit {
		return fmt.Errorf("field %s: must be <= %v", "io_combine_limit", 32)
	}
	if 1 > plain.IoCombineLimit {
	...
	if v, ok := raw["krb_server_keyfile"]; !ok || v == nil {
		plain.KrbServerKeyfile = "FILE:/opt/pginstaller_17.auto/server/staging_cache/osx/etc/postgresql/krb5.keytab"
	}
	...
	if v, ok := raw["recursive_worktable_factor"]; !ok || v == nil {
		plain.RecursiveWorktableFactor = 0.0
	}
	if 1e+06 < plain.RecursiveWorktableFactor {
	...
	if v, ok := raw["temp_file_limit"]; !ok || v == nil {
		plain.TempFileLimit = 0.0
	}
	if 2147483647 < plain.TempFileLimit {
		return fmt.Errorf("field %s: must be <= %v", "temp_file_limit", 2147483647)
	}
	if -1 > plain.TempFileLimit {
	...
	if v, ok := raw["vacuum_cost_page_hit"]; !ok || v == nil {
		plain.VacuumCostPageHit = 0.0
	}
	if 10000 < plain.VacuumCostPageHit {
		return fmt.Errorf("field %s: must be <= %v", "vacuum_cost_page_hit", 10000)
	}
	if v, ok := raw["vacuum_cost_page_miss"]; !ok || v == nil {
		plain.VacuumCostPageMiss = 0.0
	}
	if 10000 < plain.VacuumCostPageMiss {
	...
	if v, ok := raw["wal_buffers"]; !ok || v == nil {
		plain.WalBuffers = 0.0
	}
	if 262143 < plain.WalBuffers {
		return fmt.Errorf("field %s: must be <= %v", "wal_buffers", 262143)
	}
	if -1 > plain.WalBuffers {
	...
	if v, ok := raw["wal_decode_buffer_size"]; !ok || v == nil {
		plain.WalDecodeBufferSize = 0.0
	}
	if 1073741823 < plain.WalDecodeBufferSize {
		return fmt.Errorf("field %s: must be <= %v", "wal_decode_buffer_size", 1073741823)
	}
	if 65536 > plain.WalDecodeBufferSize {
	...
	if v, ok := raw["wal_keep_size"]; !ok || v == nil {
		plain.WalKeepSize = 0.0
	}
	if 2147483647 < plain.WalKeepSize {
	...
	if v, ok := raw["wal_skip_threshold"]; !ok || v == nil {
		plain.WalSkipThreshold = 0.0
	}
	if 2147483647 < plain.WalSkipThreshold {
